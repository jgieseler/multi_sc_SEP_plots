...
if mode == 'regular':
    ...
    first_date = dt.datetime(2023, 2, 17, 15)
    last_date = dt.datetime(2023, 2, 19, 12)
    plot_period = last_date-first_date  # '7D'
...
for i in tqdm(range(0, 1)):  # standard
    ...
    if plot_e_100:
        ...
        if add_ept_conta_ch:
            ept_conta_color = 'red'  #solo_ept_color  # 'cyan'
            if len(ept_p) > 0:
        ...
        if add_contaminating_channels:
            ...
            starttime_shade = dt.datetime(2023, 2, 18, 6, 40)
            endtime_shade = dt.datetime(2023, 2, 19, 12, 00)
            ax2.axvspan(starttime_shade, 
                        endtime_shade,
                        alpha=0.1,  # alpha value of the shading from 0.0 to 1.0 
                        facecolor="black", 
